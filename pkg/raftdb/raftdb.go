...
import (
    ...
    "github.com/marciobarbosa/url-shortener/pkg/raftseg"
)
...
func Init(params InitParams) (error) {
    var sparams raftseg.InitParams
...
func Insert(key []byte, value []byte) (Status) {
    ...
    exists, err := raftseg.Put(key, value)
    if err != nil {
